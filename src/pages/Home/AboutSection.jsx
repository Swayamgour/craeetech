                    ...
                    <div className={styles.visualColumn}>
                        ...
                        >
                            <div className={styles.counterBox}>
                                <h3>30<span>+</span></h3>
                                <p>Industrial Years of Experience</p>
                            </div>
                            ...
                            <div className={styles.cardContent}>
                                <div className={styles.cardIcon}>
                                    <img src={'/assets/iconss.png'} alt="Icon" />
                                </div>
                                <p>
                                    Nexella is a dynamic digital marketing agency
                                    dedicated to empowering businesses through
                                    innovative and results-driven online.
                                </p>
